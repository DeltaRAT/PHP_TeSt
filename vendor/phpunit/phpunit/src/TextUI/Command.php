...
class Command
{
    ...
    public function run(array $argv, bool $exit = true): int
    {
        ...
        if ($this->arguments['tests'] instanceof TestSuite) {
        ...
        unset($this->arguments['tests'], $this->arguments['testFile']);
    ...
    protected function handleArguments(array $argv): void
    {
        ...
        if (!isset($this->arguments['tests']) && $arguments->hasArgument()) {
            $this->arguments['tests'] = realpath($arguments->argument());

            if ($this->arguments['tests'] === false) {
                $this->exitWithErrorMessage(
                    sprintf(
                        'Cannot open file "%s".',
                        $arguments->argument()
        ...
        if (isset($this->arguments['configuration'])) {
            ...
            if (!isset($this->arguments['tests'])) {
                try {
                    $this->arguments['tests'] = (new TestSuiteMapper)->map(
    ...
    {
        $this->warnings[] = 'Using a custom tests suite loader is deprecated';
    ...
    private function handleListGroups(TestSuite $suite, bool $exit): int
    {
        ...
        print 'Available tests group(s):' . PHP_EOL;
    ...
    private function handleListSuites(bool $exit): int
    {
        ...
        print 'Available tests suite(s):' . PHP_EOL;
