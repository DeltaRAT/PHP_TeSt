...
abstract class TestCase extends Assert implements Reorderable, SelfDescribing, Test
{
        ...
        while (!empty($stack)) {
            ...
            if (isset($frame['object']) && $frame['object'] instanceof self) {
                $frame['object']->addWarning(
                    'The at() matcher has been deprecated. It will be removed in PHPUnit 10. Please refactor your tests to not rely on the order in which methods are invoked.'
                );
    ...
    /**
     * Sets up an expectation for an exception to be raised by the code under tests.
    ...
    /**
     * Returns the normalized tests name as class::method.
     *
    ...
    /**
     * Returns a tests proxy for the specified class.
     *
     * @psalm-template RealInstanceType of object
     * @psalm-param class-string<RealInstanceType> $originalClassName
     * @psalm-return MockObject&RealInstanceType
     ...
     *
     * This method is called between setUp() and tests.
     */
     ...
     * Performs assertions shared by all tests of a tests case.
     *
     * This method is called between tests and tearDown().
     */
    ...
    private function markWarningForUncallableDependency(ExecutionOrderDependency $dependency): void
    {
        ...
        $this->result->addWarning(
            ...
            new Warning(
                sprintf(
                    'This tests depends on "%s" which does not exist.',
                    $dependency->getTarget()
                )
            ),
            0
