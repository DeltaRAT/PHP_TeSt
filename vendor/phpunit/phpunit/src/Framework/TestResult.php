...
final class TestResult implements Countable
{
    ...
    /**
     * Informs the result that a tests suite will be started.
     */
    ...
    /**
     * Informs the result that a tests suite was completed.
     */
    ...
    public function run(Test $test): void
    {
            ...
            if (!isset($annotations['class']['covers']) &&
                ...
                $this->addFailure(
                    ...
                    new MissingCoversAnnotationException(
                        'This tests does not have a @covers annotation but is expected to have one'
                    ),
                    $time
                );
        ...
        if ($error) {
            ...
            $this->addFailure(
                ...
                new RiskyTestError(
                    sprintf(
                        'This tests is annotated with "@doesNotPerformAssertions" but performed %d assertions',
